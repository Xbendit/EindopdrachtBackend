...
INSERT INTO wallets (wallet_adress, crypto_currency, balance, user_id)
VALUES
    ('bc1qalice123', 'BTC', 500000, 1),
    ('0xBobEth123', 'ETH', 2000000, 2),
    ('bc1qcharlie456', 'BTC', 100000, 3);

-- Orders (gekoppeld aan user + wallet)
INSERT INTO orders (order_type, amount, price, crypto_currency, timestamp, status, user_id, wallet_id)
VALUES
    ('BUY', 1, 30000, 'BTC', '2025-08-21T10:15:00', 'OPEN', 1, 1),
    ('SELL', 2, 2000, 'ETH', '2025-08-22T11:30:00', 'EXECUTED', 2, 2),
